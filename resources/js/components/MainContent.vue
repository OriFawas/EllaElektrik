    ...
    <section class="bg-[#d8ccc0] py-12 px-8 text-center">
      ...
      <div class="flex flex-wrap justify-center gap-10">
        ...
        <div
          ...
          <img src="/images/rumah-tangga.png" alt="Elektronik Rumah Tangga" class="w-20 h-20 mb-4">
        ...
        <div
          class="bg-gray-200 shadow-md hover:shadow-lg rounded-xl w-60 h-60 flex flex-col items-center justify-center transition">
          <img src="/images/dapur.png" alt="Elektronik Dapur" class="w-20 h-20 mb-4">
        ...
        <div
          class="bg-gray-200 shadow-md hover:shadow-lg rounded-xl w-60 h-60 flex flex-col items-center justify-center transition">
          <img src="/images/kelistrikan.png" alt="Kelistrikan" class="w-20 h-20 mb-4">
